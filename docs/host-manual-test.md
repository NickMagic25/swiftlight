...
7. Launch an app, disconnect locally, and confirm the app continues running on the host. Resume it. Use the explicit Quit Host App command, confirm the destructive intent in the UI, and check it terminates on the host.
