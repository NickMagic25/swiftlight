...
The Swift tests and `python3 docs/host-otp-vectors.py` share two independently computed vectors, including an uppercase salt with A-F and Unicode/space/plus/ampersand in the passphrase. No real pairing material is in the fixtures.
